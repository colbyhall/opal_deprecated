...
public:
	...
	OP_ALWAYS_INLINE ComPtr<ID3D12DescriptorHeap> the() const { return m_heap; }
...
public:
	...
	OP_ALWAYS_INLINE ComPtr<ID3D12RootSignature> the() const { return m_root_signature; }

	OP_ALWAYS_INLINE const D3D12DescriptorHeap& rtv_heap() const { return m_rtv_heap; }
	OP_ALWAYS_INLINE const D3D12DescriptorHeap& dsv_heap() const { return m_dsv_heap; }
	OP_ALWAYS_INLINE const D3D12DescriptorHeap& bt2dv_heap() const { return m_bt2dv_heap; }

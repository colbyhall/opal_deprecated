...
public:
	...
	EU_ALWAYS_INLINE void store(T desired,
								Order order = Order::SeqCst) const noexcept;
	EU_ALWAYS_INLINE T load(Order order = Order::SeqCst) const noexcept;
	EU_ALWAYS_INLINE T exchange(T desired,
								Order order = Order::SeqCst) const noexcept;
	...
	EU_ALWAYS_INLINE T fetch_add(T arg,
								 Order order = Order::SeqCst) const noexcept;
	EU_ALWAYS_INLINE T fetch_sub(T arg,
								 Order order = Order::SeqCst) const noexcept;
	EU_ALWAYS_INLINE T fetch_and(T arg,
								 Order order = Order::SeqCst) const noexcept;
	EU_ALWAYS_INLINE T fetch_or(T arg,
								Order order = Order::SeqCst) const noexcept;
	EU_ALWAYS_INLINE T fetch_xor(T arg,
								 Order order = Order::SeqCst) const noexcept;
